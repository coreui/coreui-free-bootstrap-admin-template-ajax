...
The [issue tracker](https://github.com/coreui/coreui-free-bootstrap-admin-template-ajax/issues) is the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests), but please respect the following restrictions:
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/coreui/coreui-free-bootstrap-admin-template-ajax.git
   ```
